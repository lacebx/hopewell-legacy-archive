...
const LANDMARKS = {
  cherokeeTown: {
    ...
    location: "About 6 miles southeast of modern Pauls Valley, along the Washita River and Cherokee Sandy Creek.",
    details: [
  ...
  hopewell: {
    ...
    location: "A few miles northeast of Cherokee Town, about 4 miles north of present-day Wynnewood.",
    details: [
...
const CEMETERY_LEGACY = {
  location: "4 miles north of Wynnewood, just east of N County Road 3280, Garvin County, Oklahoma.",
